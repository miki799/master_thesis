...
display_help() {
  ...
  echo "Arguments:"
  echo "basic - creates basic cluster with enabled audit logging"
  echo "secured - creates cluster with enabled audit logging, configured Pod Security Standards and enabled encryption of data at rest"
  echo "Options:"
